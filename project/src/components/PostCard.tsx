...
const PostCard: React.FC<PostCardProps> = ({ post, onUpdate, onSchedule, onPublish }) => {
  ...
  const handleHeadlineChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setEditedPost({ ...editedPost, headline: e.target.value });
  };
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6">
            {isEditing ? (
              <textarea
                ...
                className="w-full text-center text-white text-2xl font-bold bg-transparent border-2 border-white border-dashed rounded-lg p-4 resize-none focus:outline-none focus:border-pink-400 transition-colors"
        ...
        <button
          ...
          className={`absolute top-4 left-4 w-8 h-8 rounded-full flex items-center justify-center shadow-lg transition-colors ${
